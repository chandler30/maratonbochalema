...
const WhatsAppButton = () => {
    ...
    const phoneNumber = "573222142219";
    const message = "Hola! Me gustaría más información sobre el Running Bochalema";
            ...
            {isOpen && (
                <div className="whatsapp-widget">
                    <div className="widget-header">
                        ...
                        <img
                            src="/LOGO.webp"
                            alt="Running Bochalema"
                            className="profile-pic"
                        />
                        <div className="header-info">
                            <h3>Running Bochalema</h3>
                            <p>Respondo en pocos minutos</p>
                        </div>
                    </div>
                    <div className="widget-body">
                        <div className="message-bubble">
                            ¡Hola! Bienvenido a Running Bochalema. ¡Escríbenos!
                        </div>
                    </div>
